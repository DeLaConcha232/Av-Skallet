            ...
            <main className='flex justify-start items-center flex-col h-full w-auto lg:mt-20'>
                ...
                <article id="title-subtitle" className="flex justify-center items-center flex-col gap-16">
                    <section className='flex justify-center items-center flex-col gap-4'>
                        <h1 id='title' className='text-center text-4xl text-background font-Bona md:text-6xl lg:text-7xl lg:mt-0 tracking-widest'>AV-SKALLET</h1>
                        <h2 id='subtitle' className='text-center text-lg text-second font-Rubik md:text-xl lg:text-2xl'>Todo empieza con una idea</h2>
                    </section>
